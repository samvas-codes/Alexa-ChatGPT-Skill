...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input: HandlerInput) -> Response:
        speak_output = "Welcome, you are now talking to your AI assistant, ask a question or you can also prompt me by saying - ask open AI a question"
        return (
...
class AskChatgptIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input: HandlerInput) -> Response:
        ...
        logger.info("OpenAI says: " + speak_output)
        return (
            handler_input.response_builder.speak(speak_output)
